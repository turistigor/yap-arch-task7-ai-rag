...
- добавление скрипта обновления индекса в cron описано в [документе](./rag-bot/README.md#добавление-скрипта-обновления-индекса-в-cron);
- ручной запуск скрипта вручную описан в [документе](./rag-bot/README.md#запуск-скрипта-обновления-индекса);
...
- пример лога успешного обновления: [скрин](./pictures/index_updater_log_file.png).
...
- логи сохраняются в [папку](./rag-bot/logs/), настроена ротация через 1МБ;
...
Запуск автоматизированного тестирования описан в [документе](./rag-bot/README.md#тестирование-бота).  
Основные компоненты:
